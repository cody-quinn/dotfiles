...
globalkeys = gears.table.join(
    -- AwesomeWM Specific
    awful.key({ modkey, "Control", "Shift" }, "s", hotkeys_popup.show_help, {description="show help", group="awesome"}),
    ...
    -- Standard programs
    awful.key({ modkey, "Shift"   }, "Return", spawn_proc(terminal),                    {description = "open a terminal",  group = "launcher"}),
